        ...
        <div id='especialidad' className='flex flex-col items-center gap-4 py-16 text-gray-800'>
            ...
            <div className='flex sm:justify-center gap-4 pt-5 w-full  '>
                {specialityData.map((item, index) => (
                    <Link to={`/doctores/`} onClick={() => scrollTo(0, 0)} className='flex flex-col text-center items-center p-5 bg-fondo m-2 rounded-lg gap-2 hover:translate-y-[-10px] ransition-all duration-500' key={index}>
